                            ...
                            <div class="form-group row border">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="0" step="any" class="form-control" v-model="precio" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>Cantidad <span style="color:red;" v-show="cantidad==0">(*) Ingrese</span></label>
                                        <input type="number" value="0" class="form-control" v-model="cantidad" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            calcularTotal: function(){
                ...
                for (let index = 0; index < this.arrayDetalle.length; index++) {
                    const element = this.arrayDetalle[index];
                    var subtotal = element.cantidad * element.precio;
                    resultado += subtotal;
        ...
        methods : {
            ...
            agregarDetalle(){
                let me = this;
                if(me.idarticulo==0 || me.cantidad==0 || me.price==0){

                }else{
                    if(me.encuentra(me.idarticulo)){
                        swal.fire(
                            'Error',
                            'Este articulo ya se encuentra agregado',
                            'error'
                        );
                    }else{
