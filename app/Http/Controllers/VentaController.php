...
class VentaController extends Controller
{
    ...
    public function obtenerDetalles(Request $request){
        ...
        $id = $request->id;
        $detalles = VentaDetalle::join('articulos','detalle_ventas.idarticulo','=','articulos.id')
    ...
    public function pdf($id, Request $request){
        ...
        ->join('users','ventas.idusuario','=','users.id')
        ->select('ventas.id','ventas.tipo_comprobante','ventas.serie_comprobante',
        'ventas.num_comprobante','ventas.created_at','ventas.fecha_hora','ventas.impuesto',
        'ventas.total', 'ventas.estado','personas.nombre','personas.tipo_documento',
        'personas.num_documento','personas.direccion','personas.telefono','personas.email', 'users.usuario')
        ...
        return view('pdf.venta',['venta'=>$venta,'detalles'=>$detalles]);
